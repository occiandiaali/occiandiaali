...
🔭  Currently building MVPs and prototypes with ES6+ tools, cross-platform web/mobile frameworks, Machine Learning, SQL/NoSQL packages, and Ruby on Rails, while playing with Kotlin Multiplatform and Golang on the side.  
