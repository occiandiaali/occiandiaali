...
🔭  Currently building MVPs and prototypes with ES6+ tools, cross-platform web/mobile frameworks, Machine Learning, SQL/NoSQL packages, and (some) Ruby on Rails, while exploring Kotlin Multiplatform on the side.  
